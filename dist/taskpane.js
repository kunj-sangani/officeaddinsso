...
var sso = __importStar(__webpack_require__(/*! office-addin-sso */ "./node_modules/office-addin-sso/lib/main.js"));
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          if (!(messageFromDialog.status === "success")) return [3 /*break*/, 2];
          // We now have a valid access token.
          loginDialog.close();
          return [4 /*yield*/, sso.makeGraphApiCall(messageFromDialog.result)];
        case 1:
          response = _a.sent();
...
var office_addin_sso_1 = __webpack_require__(/*! office-addin-sso */ "./node_modules/office-addin-sso/lib/main.js");
/* global OfficeRuntime */
var retryGetAccessToken = 0;
function getGraphData(callback) {
  return __awaiter(this, void 0, void 0, function () {
    var bootstrapToken, response, mfaBootstrapToken, exception_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 5,, 6]);
        ...
        case 1:
          ...
          return [4 /*yield*/, (0, office_addin_sso_1.makeGraphApiCall)(bootstrapToken)];
        case 2:
          response = _a.sent();
          if (!response.claims) return [3 /*break*/, 4];
          return [4 /*yield*/, OfficeRuntime.auth.getAccessToken({
            authChallenge: response.claims
          })];
        case 3:
          mfaBootstrapToken = _a.sent();
          response = (0, office_addin_sso_1.makeGraphApiCall)(mfaBootstrapToken);
          _a.label = 4;
        case 4:
        ...
        case 5:
          ...
          if (exception_1.code) {
            if ((0, office_addin_sso_1.handleClientSideErrors)(exception_1)) {
              (0, fallbackauthhelper_1.dialogFallback)(callback);
            }
          } else {
            (0, office_addin_sso_1.showMessage)("EXCEPTION: " + JSON.stringify(exception_1));
            Promise.reject();
          }
          return [3 /*break*/, 6];
        case 6:
...
exports.writeDataToOfficeDocument = exports.run = void 0;
...
function run() {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      (0, ssoauthhelper_1.getGraphData)(writeDataToOfficeDocument);
      return [2 /*return*/];
    });
  });
}
